...
cat $PROCESSED/sample_name.txt | parallel --bar -j 50 "tb-profiler profile -a $RAW/{}.bam -p {}"
...
# tb-profiler profile -a /mnt/storage7/jody/tb_ena/per_sample/ERR2864244.bqsr.cram -p ERR2864244.json
# tb-profiler profile -a /mnt/storage7/jody/tb_ena/per_sample/ERR2503407.bqsr.cram -p ERR2503407.json
# tb-profiler profile -a /mnt/storage7/jody/tb_ena/per_sample/ERR751749.bqsr.cram -p ERR751749.json
