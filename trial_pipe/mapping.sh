...
#bwa index $REFGENOME <-do this only once, it's done in the mapping_parallel script

#Transfer sam to binary and index the bam file
echo ***bwa: sam to bam***
bwa mem -c 100 -R "@RG\tID:$1\tSM:$1\tPL:Illumina" -M -T 50 $REFGENOME ${1}_1P ${1}_2P | samtools sort -o $1.bam -
